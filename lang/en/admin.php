...
$string['allowcoursethemes'] = 'Allow Interview themes';
...
$string['backup_shortname'] = 'Use Interview name in backup filename';
$string['backup_shortnamehelp'] = 'Use the Interview name as part of the backup filename.';
...
$string['blockprotect_help'] = 'If you lock a particular type of block, then no-one will be able to add or delete instances. (You can, of Interview, unlock again if you need to edit instances.)
...
$string['calendartype_desc'] = 'Choose a default calendar type for the whole site. This setting can be overridden in the Interview settings or by users in their personal profile.';
...
$string['configallowcategorythemes'] = 'If you enable this, then themes can be set at the category level. This will affect all child categories and Interview unless they have specifically set their own theme. WARNING: Enabling category themes may affect performance.';
...
$string['configallowcoursethemes'] = 'If enabled, then Interviews will be allowed to set their own themes.  Interview themes override all other theme choices (site, user, category, cohort or URL-defined themes).';
...
$string['configautologinguests'] = 'Should visitors be logged in as guests automatically when entering Interviews with guest access?';
...
$string['configcoursegraceperiodafter'] = 'Classify past Interviews as in progress for these many days after the Interview end date.';
...
$string['configcourseoverviewfileslimit'] = 'The maximum number of files that can be displayed next to the course summary on the list of courses page. The first image file added is used as the Interview image in the Interview overview on users\' Dashboards; any additional files are displayed on the list of courses page only.';
...
$string['configfrontpagecourselimit'] = 'Maximum number of Interviews';
$string['configfrontpagecourselimithelp'] = 'Maximum number of Interviews to be displayed on the site home in course listings.';
...
$string['confignavshowallcourses'] = 'This setting determines whether users who are enrolled in courses can see Courses (listing all courses) in the navigation, in addition to My Interviews (listing courses in which they are enrolled).';
...
$string['courserequestnotify'] = 'Interview request notification';
...
$string['courses'] = 'Interviews';
$string['coursesperpage'] = 'Interviews per page';
...
$string['mycoursesperpage'] = 'Number of Interviews';
...
$string['navshowmycoursecategories_help'] = 'If enabled, courses in the user\'s My Interviews branch will be shown in categories in the navigation block (Classic-based themes only).';
...
$string['navsortmycoursessort_help'] = 'This determines whether courses are listed under My Interviews according to the sort order (i.e. the order set in Site administration > Courses > Manage courses and categories) or alphabetically by course setting.';
$string['never'] = 'Never';
