...
$string['actenrolshhdr'] = 'Available Interview enrolment plugins';
...
$string['assignnotpermitted'] = 'You do not have permission or can not assign roles in this Interview.';
...
$string['defaultenrol'] = 'Add instance to new Interviews';
$string['defaultenrol_desc'] = 'It is possible to add this plugin to all new Interviews by default.';
$string['deleteinstanceconfirm'] = 'You are about to delete the enrolment method "{$a->name}". All {$a->users} users currently enrolled using this method will be unenrolled and any Interview-related data such as users\' grades, group membership or forum subscriptions will be deleted.

Are you sure you want to continue?';
$string['deleteinstanceconfirmself'] = 'Are you really sure you want to delete instance "{$a->name}" that gives you access to this Interview? It is possible that you will not be able to access this Interview if you continue.';
...
$string['disableinstanceconfirmself'] = 'Are you really sure you want to disable instance "{$a->name}" that gives you access to this Interview? It is possible that you will not be able to access this Interview if you continue.';
...
$string['enrolme'] = 'Enrol me in this Interview';
$string['enrolmentinstances'] = 'Enrolment methods';
$string['enrolmentnew'] = 'New enrolment in {$a}';
$string['enrolmentnewuser'] = '{$a->user} has enrolled in Interview "{$a->course}"';
...
$string['enrolnotpermitted'] = 'You do not have permission or are not allowed to enrol someone in this Interview';
...
$string['errorenrolcohort'] = 'Error creating cohort sync enrolment instance in this Interview.';
$string['errorenrolcohortusers'] = 'Error enrolling cohort members in this Interview.';
...
$string['eventuserenrolmentcreated'] = 'User enrolled in Interview';
$string['eventuserenrolmentdeleted'] = 'User unenrolled from Interview';
...
$string['instanceeditselfwarningtext'] = 'You are enrolled into this Interview through this enrolment method, changes may affect your access to this Interview.';
...
$string['noguestaccess'] = 'Guests cannot access this Interview. Please log in.';
$string['none'] = 'None';
$string['notenrollable'] = 'You cannot enrol yourself in this Interview.';
$string['notenrolledusers'] = 'Other users';
$string['otheruserdesc'] = 'The following users are not enrolled in this Interview but do have roles, inherited or assigned within it.';
...
$string['rolefromthiscourse'] = '{$a->role} (Assigned in this Interview)';
$string['rolefrommetacourse'] = '{$a->role} (Inherited from parent Interview)';
$string['rolefromcategory'] = '{$a->role} (Inherited from Interview category)';
$string['rolefromsystem'] = '{$a->role} (Assigned at site level)';
$string['sendfromcoursecontact'] = 'From the Interview contact';
...
$string['unassignnotpermitted'] = 'You do not have permission to unassign roles in this Interview';
$string['unenrol'] = 'Unenrol';
$string['unenrolleduser'] = 'The user "{$a->fullname}" was unenrolled from the Interview';
...
$string['unenrolnotpermitted'] = 'You do not have permission to unenrol this user from the Interview.';
...
$string['extremovedaction_help'] = 'Select action to carry out when user enrolment disappears from external enrolment source. Please note that some user data and settings are purged from Interview during Interview unenrolment.';
$string['extremovedsuspend'] = 'Disable Interview enrolment';
$string['extremovedsuspendnoroles'] = 'Disable Interview enrolment and remove roles';
$string['extremovedkeep'] = 'Keep user enrolled';
$string['extremovedunenrol'] = 'Unenrol user from Interview';
...
$string['privacy:metadata:user_enrolments:status'] = 'The status of the user enrolment in a Interview';
...
$string['youenrolledincourse'] = 'You are enrolled in the Interview.';
$string['youunenrolledfromcourse'] = 'You are unenrolled from the Interview "{$a}".';

// Deprecated since Moodle 4.0.
$string['proceedtocourse'] = 'Proceed to Interview content';
