...
$string['privacy:courserequestpath'] = 'Requested Interviews';
...
$string['privacy:lastaccesspath'] = 'Last access to Interviews';
...
$string['privacy:metadata:courseid'] = 'Interview ID';
...
$string['privacy:metadata:fullname'] = 'The fullname for this Interview.';
...
$string['privacy:metadata:lastaccesstablesummary'] = 'Information about the last time a user accessed a Interview.';
...
$string['privacy:metadata:reason'] = 'The reason for requesting this Interview.';
$string['privacy:metadata:requester'] = 'The ID of the user who requested the Interview';
$string['privacy:metadata:requestsummary'] = 'Stores information about requests for Interview that users make.';
...
$string['privacy:metadata:shortname'] = 'A short name for the Interview.';
...
$string['privacy:metadata:summary'] = 'A description of the Interview.';
$string['privacy:metadata:theme'] = 'A user preference for the theme to display.';
$string['privacy:metadata:timeaccess'] = 'The time for access to the Interview.';
